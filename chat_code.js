        ...
        if (name == usernamesa) {
          ...
          if (message_data['type'] == 'Msg') {
            ...
            if (message_data['fileUrl'].includes('pdf')) {
              ...
              document.getElementById('output').innerHTML += "<h4> " + name + "<img class='user_tick' src='tick.png'></h4>" + "<h4 style='word-break: break-all;'>Download Button of your " + str2 + " file:<a href=" + mainUrl + "><button class='btn btn-info'><img src='download.svg'></img> Download</button></h4></a><button class='btn btn-danger' id=" + firebase_message_id + " onclick='deletet(this.id)'>Delete</button><hr><br><br>";
          ...
          if (message_data['type'] == 'Msg') {
            ...
            if (message_data['fileUrl'].includes('pdf')) {
              ...
              console.log(slug)
              str2 = slug.charAt(0).toUpperCase() + slug.slice(1);
              document.getElementById('output').innerHTML += "<h4> " + name + "<img class='user_tick' src='tick.png'></h4>" + "<h4>Download Button of your" + str2 + " file:<a href=" + mainUrl + "><button class='btn btn-info'><img src='download.svg'></img> Download</button></h4></a><hr><br><br>";
